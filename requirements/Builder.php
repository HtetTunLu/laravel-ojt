...
class Builder
{
    ...
    const MODE_CONFIRM = 'confirm_update';
    const MODE_CONFIRM_CREATE = 'confirm_create';
    ...
    public function getAction(): string
    {
        ...
        if ($this->isMode(static::MODE_CONFIRM)) {
            return $this->form->resource(-1);
        }
        ...
        // if ($this->isMode(static::MODE_CONFIRM_CREATE)) {
        //     return $this->form->resource() . '/posts';
        // }
    ...
    public function title(): string
    {
        ...
        if ($this->mode === static::MODE_CONFIRM) {
            return trans('admin.confirm_update');
        }

        if ($this->mode === static::MODE_CONFIRM_CREATE) {
            return trans('admin.confirm_create');
        }
