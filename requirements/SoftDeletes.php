...
trait SoftDeletes
{
    ...
    public function initializeSoftDeletes()
    {
        ...
        if (!isset($this->casts[$this->getDeletedUserColumn()])) {
            $this->casts[$this->getDeletedUserColumn()] = 'integer';
        }
    }
    ...
    protected function runSoftDelete()
    {
        ...
        $columns = [$this->getDeletedAtColumn() => $this->fromDateTime($time), $this->getDeletedUserColumn() => \Illuminate\Support\Facades\Auth::user()->id];

        $this->{$this->getDeletedAtColumn()} = $time;
        $this->{$this->getDeletedUserColumn()} = \Illuminate\Support\Facades\Auth::user()->id;
    ...
    public function getDeletedUserColumn()
    {
        return defined(static::class . '::DELETED_USER_ID') ? static::DELETED_USER_ID : 'deleted_user_id';
    }
    ...
    public function getQualifiedDeletedUserColumn()
    {
        return $this->qualifyColumn($this->getDeletedUserColumn());
    }
}
